...
class TurtleShell(cmd.Cmd):
    ...
    def do_left(self, arg):
        ''' Turn turtle left by given number of degrees: LEFT 100
        '''
        left(*parse(arg))
    ...
    def do_circle(self, arg):
        ''' Draw a circle with given radius an options extent and steps:
        CIRCLE 50
        '''
        circle(*parse(arg))

    def do_position(self, arg):
        ''' Print the current position of the turtle: POSITION
        '''
